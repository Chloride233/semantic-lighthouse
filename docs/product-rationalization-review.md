...
**Final S1 outcome**: 1 dead code removal + 8 doc archives confirmed safe. 3 utility scripts restored after safety review. Zero navigation or product behavior changes.
